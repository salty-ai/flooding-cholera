...
from app.routers import lgas_router, analytics_router, upload_router, satellite_router, alerts_router, facilities_router, agent_router, admin_data_router, reports_router, flood_events_router, state_cholera_router
...
app.include_router(state_cholera_router)
