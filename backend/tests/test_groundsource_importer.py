...
def test_compute_flood_event_score_inputs_decay():
    ...
    s = compute_flood_event_score_inputs(area_km2=500.0, days_since_start=0)
    assert math.isclose(s, 1.0, rel_tol=1e-6)
    s_half = compute_flood_event_score_inputs(area_km2=250.0, days_since_start=0)
    assert math.isclose(s_half, 0.5, rel_tol=1e-6)
    s2 = compute_flood_event_score_inputs(area_km2=500.0, days_since_start=14)
